package ru.gb.FamilyTree.model.person;

import ru.gb.FamilyTree.model.family_tree.TreeNode;
...
//    private int age; // Возраст
    ...
    public boolean addParent(Person parent) {
        if (parent.getGender().equals(Gender.Male.toString())) {
            setFather(parent);
        } else if (parent.getGender().equals(Gender.Female.toString())) {
            setMother(parent);
        }
        return true;
    }
